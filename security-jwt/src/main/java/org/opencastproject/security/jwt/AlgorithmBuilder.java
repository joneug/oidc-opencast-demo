...
public final class AlgorithmBuilder {
  ...
  public static final String[] ASYMMETRIC_ALGORITHMS = new String[] { RS256, RS384, RS512, ES256, ES256K, ES384,
      ES512 };
  ...
  public static final String[] SYMMETRIC_ALGORITHMS = new String[] { HS256, HS384, HS512 };
  ...
  public static Algorithm buildAlgorithm(DecodedJWT jwt, PublicKey publicKey) {
    return buildAlgorithm(jwt.getAlgorithm(), publicKey);
  }
